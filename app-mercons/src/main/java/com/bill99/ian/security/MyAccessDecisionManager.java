 ...
 * 
 *oid decide(Authentication authentication, Object secureObject, 
 *ist<ConfigAttributeDefinition> config) throws AccessDeniedException; 
 *oolean supports(ConfigAttribute attribute); 
 *oolean supports(Class clazz); 
 *
	...
	public void decide(Authentication authentication, Object object,
        ...
        while (ite.hasNext()) {
            ...
            for (GrantedAuthority ga : authentication.getAuthorities()) {
            	System.out.println("应具备的权限：" + needRole.trim() + "，访问的权限：" + ga.getAuthority().trim());
                if (needRole.trim().equals(ga.getAuthority().trim())) {
                	System.out.println("AccessDecisionManager被执行：权限" + needRole + "，访问路径：" + object.toString());
                    return;
                }
            }
        }
